...
/*Table structure for table `notice_set_info` */

DROP TABLE IF EXISTS `notice_set_info`;

CREATE TABLE `notice_set_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `memberunlockswitch` int(2) NOT NULL DEFAULT '0',
  `temporaryunlockswitch` int(2) NOT NULL DEFAULT '0',
  `abnormalunlockswitch` int(2) NOT NULL DEFAULT '0',
  `appupdateswitch` int(2) NOT NULL DEFAULT '0',
  `createtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8;
